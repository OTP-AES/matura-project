...
%%First, the multiplicative inverse of the byte (within the Galois field $GF(2^8)$) is calculated. The element {00} is mapped to itself. %%%All other elements need to be calculated using finite field arithmetic.
