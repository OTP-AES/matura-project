...
The extended Euclidean algorithm is used to compute the integers $x$ and $y$ $({x,y} \in \mathbb{Z})$ of B\'ezouts Identity, in order to fulfil the following equation:
...
$x_2=x_0-x_1*q_1 \Rightarrow 1=1-0*5$
